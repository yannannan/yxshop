...
export default function OrdersPage() {
  ...
  return <main className="simple-page orders-page">
    <header className="inner-header"><Link className="brand" href="/"><span className="brand-mark"><Image src="/yxstar_logo.png" alt="宇星商城 Logo" fill sizes="34px" /></span><span>宇星商城</span></Link><span className="orders-header-label">订单中心</span><div className="orders-header-actions"><Link href="/addresses">我的地址</Link><Link href="/service-orders">技术服务订单</Link><Link href="/">返回商城</Link></div></header>
