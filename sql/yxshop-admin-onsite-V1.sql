...
(5,1,'enterprise-network-repair',0,'企业网络故障排查与修复','无法上网、网络波动与访问异常的快速排查和修复支持。','["online","onsite"]','全市服务','fixed',300.00,'小时','1–5 分钟响应','20分钟到场','[{"title":"异常定位","detail":"分析网络连通性、访问链路与异常日志。"},{"title":"修复建议","detail":"给出可执行的修复方案并协助处理。"},{"title":"结果确认","detail":"完成连通性验证并说明后续注意事项。"}]','["说明网络异常现象","选择沟通或指定地点服务","确认修复结果"]','active',50,NOW(),NOW()),
